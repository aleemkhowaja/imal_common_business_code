...
<table width="100%">
	<tr>
		<td></td>
		<td><h2><u><ps:text name="upload_correct_OFAC_Blacklist_file_key"></ps:text></u></h2></td>
	</tr>
	<tr>
		<td></td>
		<td>
			<ol>
				<li><ps:text name="open_the_key"/>
					<a href="<ps:property value="pthCtrl1VO.OFAC_WEBSITE" />" target="_new"  >
						<ps:text name="OFAC_website_key"/>
					</a>
				</li>
	...
	<tr>
		...
		<td>
			...
			&nbsp;&nbsp;&nbsp;&nbsp;
			<ps:file id="uploadOFACScript" name="fileNameOFAC" onchange="validateFileName(this);fillAsSource('O','uploadOFACScript');"  ></ps:file>		
		</td>
	</tr>
</table>

<ptt:toolBar id="blackListUpload_btnToolbarOFAC_${_pageRef}">
