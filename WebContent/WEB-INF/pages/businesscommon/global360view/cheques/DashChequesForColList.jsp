...
<%@include file="/WEB-INF/pages/common/TLDImport.jsp" %>
    ...
    <ps:set name="cifNo_${_pageRef}" value="cif_no"/>
			<ps:url id="urlChequesForColGrid_${_pageRef}" 
			        namespace="/path/globalview" escapeAmp="false"
				    action="dashChequesForColListAction?_pageRef=${_pageRef}">
			   <ps:param name="cif_no"        value="criteria.cif_no"></ps:param>
			   <ps:param name="loginTypeByBr" value="criteria.loginTypeByBr"></ps:param>
			</ps:url>

		    <psjg:grid id="chequesForColListGridTbl_Id_${_pageRef}" 
					caption="%{getText('cheques_for_coll_key')}"
			        altRows="true"
			    	dataType="json" 
					filter="true"
			    	gridModel="gridModel" 
			    	href="%{urlChequesForColGrid_${_pageRef}}"
			        navigator="true" 
			        navigatorAdd="false"
		    	...
		    	<psjg:gridColumn id="TRX_TYPE"			   index="TRX_TYPE"				colType="number" name="ctstrsVO.TRX_TYPE"			title="Hidden TRX_TYPE"							editable="false" sortable="true" search="true" hidden="true"/>
				...
				<psjg:gridColumn id="trx_no"          	   index="trx_no"          		colType="number" name="trx_no" 	      				 title="%{getText('Trx_No_key')}"	     		editable="false" sortable="true" search="true" formatter="dashboard_chequesForColTrxBtn"/>
				...
				<psjg:gridColumn id="trs_acc_gl"	  	   index="trs_acc_gl"      		colType="number" name="from_acc_gl"	  				 title="%{getText('Acc_GL_key')}" 		 		editable="false" sortable="true" search="true"/>
 ...
 <div id="DashChequesForCollDiv_id_${_pageRef}"></div>
 <script type="text/javascript">

  //Setting multi header columns
 var trs_acc_Key = "<ps:text name='Account_key'/>";
 var chequesForCollKey = "<ps:text name='cheques_for_coll_key'/>";
 
 $("#chequesForColListGridTbl_Id_"+_pageRef).jqGrid('setGroupHeaders', {
