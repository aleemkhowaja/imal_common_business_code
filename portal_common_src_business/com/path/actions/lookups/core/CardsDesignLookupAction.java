...
public class CardsDesignLookupAction extends LookupBaseAction {
	...
	{	
	    ...
	    grid.setRowNum("5");
	    grid.setUrl("/pathdesktop/CardsDesignLookup_fillCardsDesignLookup");
     ...
     * @return
     */
    public String fillCardsDesignLookup()
    {
	try
	{
	    List<CTSCARDS_DESIGNVO> cardsDesignVOList;
	    ...
	    {
		setRecords(cardsDesignBO.cardsDesignListCount(criteria));
	    }
	    cardsDesignVOList = cardsDesignBO.cardsDesignList(criteria);
	    setGridModel(cardsDesignVOList);
