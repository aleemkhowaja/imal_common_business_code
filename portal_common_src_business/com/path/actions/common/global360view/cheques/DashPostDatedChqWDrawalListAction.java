 ...
 */
public class DashPostDatedChqWDrawalListAction extends GridBaseAction 
{
     ...
     *
     */
    public String loadPostDatedChqWDrawalPage()
    {
        return SUCCESS;
    }
     ...
     *
     */
    public String postDatedChqWDrawalListGrid()
    {
  	String[] searchCol = {
  		"COMP_CODE"
		,"TRS_TYPE"
		...
		criteria.setTellerCode(sessionCO.getCtsTellerVO().getCODE());
  	    ...
  	    {
  		setRecords(dashChequesServicesBO.postDatedChqWDrawalListCount(criteria));
  	    }
  	    setGridModel(dashChequesServicesBO.postDatedChqWDrawalList(criteria));
  	}
